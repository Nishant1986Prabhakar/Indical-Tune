...
def find_arohanam_raag(key_note_played):
    ...
    for match_count in range(0,len(all_arohanam_raagas)):
        if played_arohanam_raaga == all_arohanam_raagas[match_count]:
...
def selected_raaga_to_be_played(i,key_note_played):
    for raag_loop_count in range(0,len(all_arohanam_raagas[0])):
        for i in range(len(white_keys)):
            ...
            i = i + all_arohanam_raagas[0,raag_loop_count]
            print("The Value of i is :", i)
            raag_loop_count = raag_loop_count + 1 
            key_note_played.append(key_notes.index(all_arohanam_raagas[raag_loop_count]))   
            print("The value of key_note_played is :",key_note_played)
        for i in range(len(black_keys)):
            ...
            print("The Value of i is :", i)
            raag_loop_count = raag_loop_count + 1
    #print(first_key_note,final_key_note)        
...
while run:
    ...
    if raaga_to_be_played_button.draw(screen):
        print('Clicked on Play The Raaga')
        applescript = """
        display dialog "Click On The Starting Key Notes From Where You Want To Start Playing the Raaga By The App...." ¬
        with title "This is a pop-up window" ¬
        with icon caution ¬
        buttons {"OK"}
        """
        ...
        Selected_First_Key_Note = True
        # select_scale_range(white_keys, black_keys, active_whites, active_blacks);
    ...
    for event in pygame.event.get():  
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and Selected_First_Key_Note == True: 
            print('Select The Raaga To Be Played')
            selected_raaga_to_be_played (i,key_note_played);
