...
play_raag_img = pygame.image.load('assets/Play_Raaga.png').convert_alpha()
raag_to_be_played_img = pygame.image.load('assets/Raaga_To_Be_Played.png').convert_alpha()
play_raag_button = button.Button(900, 20, play_raag_img, 0.8)
raag_to_be_played_button = button.Button(900, 50, raag_to_be_played_img, 0.8)
...
while run:
    ...
    if play_raag_button.draw(screen):
        print('Clicked on Play The Raaga')
        applescript = """
        display dialog "Play the Key Notes For Arohanam or Avarohanam...." ¬
    ...
    if raag_to_be_played_button.draw(screen):
